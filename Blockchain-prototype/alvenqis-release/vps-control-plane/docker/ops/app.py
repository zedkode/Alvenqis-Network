...
def configure(data: dict[str, Any]) -> None:
    ...
    env_values = {
        ...
        "WEBSITE_ORIGIN": data.get("website_origin") or "http://alvenqis-website-runtime:18081",
        ...
        **hosts,
        ...
        "CLOUDFLARE_TUNNEL_NAME": data.get("cloudflare_tunnel_name", "alvenqis-control-plane"),
