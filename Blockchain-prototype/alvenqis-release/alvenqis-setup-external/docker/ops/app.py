...
def write_access_summary(
    ...
    content = "\n".join(
        [
            ...
            "Operator password: <stored in secrets/admin_password>",
            f"Viewer user: {data.get('admin_viewer_user', 'alvenqis-viewer')}",
            "Viewer password: <stored in secrets/admin_viewer_password>",
            "",
            ...
            "Grafana password: <stored in secrets/grafana_password>",
            "",
