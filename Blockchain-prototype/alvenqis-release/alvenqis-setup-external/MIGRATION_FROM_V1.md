...
cp -a alvenqis-release/alvenqis-setup-external/.env /root/alvenqis-env-before-v2 2>/dev/null || true
cp -a alvenqis-release/alvenqis-setup-external/state /root/alvenqis-state-before-v2

unzip /path/to/alvenqis-setup-external-2.1.0-no-autoupdate.zip -d /tmp/alvenqis-v2
cp -a /tmp/alvenqis-v2/Alvenqis-Network/. /home/apps/alvenqis-network/

cd /home/apps/alvenqis-network/alvenqis-release/alvenqis-setup-external
