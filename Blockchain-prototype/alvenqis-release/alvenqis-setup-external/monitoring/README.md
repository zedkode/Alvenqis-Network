...
Real Prometheus scrape targets, exporters and Grafana dashboards for the Alvenqis Docker control plane (`compose` project name: `alvenqis-setup-external`).
...
```bash
cd alvenqis-release/alvenqis-setup-external
