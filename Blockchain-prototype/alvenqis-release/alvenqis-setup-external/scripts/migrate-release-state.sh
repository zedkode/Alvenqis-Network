...
load_dotenv .env
project="${COMPOSE_PROJECT_NAME:-alvenqis-setup-external}"
source_root="${MIGRATION_SOURCE_STATE_ROOT:-$root/state}"
target_root="${MIGRATION_TARGET_STATE_ROOT:-${ALVENQIS_STATE_ROOT:-/var/lib/alvenqis-setup-external}}"
...
backup_root="/var/backups/alvenqis-setup-external/pre-state-migration-$stamp"
