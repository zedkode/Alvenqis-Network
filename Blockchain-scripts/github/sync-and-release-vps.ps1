...
$versionFile = "Blockchain-prototype/alvenqis-release/vps-control-plane/VERSION"
...
if ($Help) {
  Write-Host "Usage: .\Blockchain-scripts\github\sync-and-release-vps.ps1 [-Message TEXT] [-NoWait] [-SyncOnly] [-Help]"
  exit 0
}
...
$requiredAssets = @(
  "alvenqis-docker-control-plane.tar.gz",
  "alvenqis-docker-control-plane.tar.gz.sha256",
