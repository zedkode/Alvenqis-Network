...
function hasMojibake(content) {
  ...
  // Romanian letters with diacritics.
...
const { stdout: gitCandidates } = await execFileAsync(
  'git',
...
for (const file of candidateFiles) {
  try {
    ...
    // Deleted working-tree files are intentionally absent from the generated inventory.
  }
}
const rows = []
const errors = []
